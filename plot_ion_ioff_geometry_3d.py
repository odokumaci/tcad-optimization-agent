"""Plot ION/IOFF ratio versus gate length and oxide thickness."""
...
OUTPUT = ROOT / "assets" / "mos_2d_ion_ioff_vs_geometry.png"
...
def main() -> None:
    ...
    ax.set_zlabel("ION/IOFF ratio (×10³)", labelpad=10)
    ax.set_title("ION/IOFF ratio versus gate length and oxide thickness")
    ...
    fig.text(
        0.5,
        0.02,
        "ION: VG = VD = 1.2 V · IOFF: VG = 0 V, VD = 1.2 V · Source: dataset/pilot/summary.csv",
        ha="center",
        fontsize=9,
        color="0.35",
    )
