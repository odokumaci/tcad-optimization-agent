"""Plot ION versus physical gate length and oxide thickness."""
...
OUTPUT = ROOT / "assets" / "mos_2d_ion_vs_geometry.png"
...
def main() -> None:
    ...
    ax.set_zlabel("ION (µA/µm)", labelpad=10)
    ax.set_title("On-current versus gate length and oxide thickness")
    ...
    fig.text(
        0.5,
        0.02,
        "ION evaluated at VG = VD = 1.2 V · Source: dataset/pilot/summary.csv",
        ha="center",
        fontsize=9,
        color="0.35",
    )
